    ...
    <div>
      ...
      <form class="" method = "POST" action = "form.php">
        ...
        <section class="container d-block">
          ...
          <div class="row m-5">
            <form class="col">
            <label class="p-0 mb-1" for="ettevottenimi">Company name</label>
              <input
              ...
              <input
                ...
                name = "lisakysimused"
              />
              <label class="p-0 mb-1" for="email">Leave us your e-mail if you want us to contact you personally!</label>
              <input
                class="form-control mb-3"
                type="text"
