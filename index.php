    ...
    <header class="navbar navbar-expand-lg bg-secondary bg-opacity-25">
      ...
      >
        ...
        <ul class="navbar-nav justify-content-between align-items-center">
          ...
          <li class="nav-ite d-flex justify-content-center">
    ...
    <div class="">
      ...
      <form method = "POST" action="form.php">
        <section class="container">
          ...
          <div class="row my-4 text-center px-2">
          ...
          <div class="row m-5">
            <form class="col">
              ...
              <input
                ...
                name = "lisakysimused"
              />
              <label class="p-0 mb-1" for="email">Jäta meile oma e-mail kui soovid, et võtaksime Sinuga personaalselt ühendust!</label>
              <input
                class="form-control mb-3"
                type="text"
